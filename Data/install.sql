...
INSERT INTO `ly_admin_nav` (`id`, `group`, `pid`, `title`, `type`, `value`, `api_route`, `target`, `icon`, `cover`, `lists_template`, `detail_template`, `create_time`, `update_time`, `sort`, `status`)
VALUES
...
INSERT INTO `ly_site_category` (`id`, `cate_type`, `pid`, `title`, `content`, `url`, `cover`, `banner`, `is_show`, `lists_template`, `detail_template`, `create_time`, `update_time`, `sort`, `status`)
VALUES
